...
if __name__ == '__main__':
    ...
    # # plt.show()
    #
    # trajectory = rrt(rob, obstacles, start, goal, 0, 10, 1, 5, 1000)
    # if len(trajectory) > 0:
    ...
    ######################################################################
    ### TESTs RRT algorithms of Dynamic Four wheel car
    ######################################################################
    ...
    for n in range(rounds):
        ...
        for i in range(total):
            ...
            while True:
                ...
                # Check if the randomly generated goal is valid or not.
